...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* LAYER 1: Eiffel Tower as an <img> element — object-fit: contain, no cropping */}
      <img
      ...
      {/* LAYER 2: Directional Blur Mask (Top 25%, 6px blur max) */}
      <div
      ...
      {/* LAYER 3: Text Safe Zone Gradient — Desktop: left-to-right, Mobile: top-to-bottom */}
      <div
        ...
        <div className="section-padding">
          ...
          <div className="min-h-screen flex items-start pt-[130px] lg:pt-[120px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-8 items-start w-full pb-12 lg:pb-0">
              ...
              {/* Right: Google Mockup — relative z-2, margin-top ensures it stays below header */}
              <div
